...
interval = 4   #8:00 12:00 16:00 20:00
times = 1
time_count = True
times = 1
day = 0
...
while True:
    ...
    if button_a.was_pressed(): #First time, user should press the button
        ...
        display.clear()
        time_count = True
        #Click the button at 00:00
        while time_count:
            for times in range(1,5):  #loop for write data to the file
                if (times % 5 == 1):
            ...
            #4th time
                    ...
                    with open("box_data.txt", "w") as file_object:
                        ...
                        file_object.write(text)
                    times += 1
                    display.scroll("20pm F")

                else:
                    time.sleep(3)
                    display.scroll("New day start")
                    times = 1
                    time.sleep(14400)
